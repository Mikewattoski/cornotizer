<nav class="navbar navbar-dark  navbar-expand-lg fixed-top" style="background-color: #FF4A52 !important;" >
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">ConoTizer</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
                        @if (!auth()->check())
                            ...
                            <a class="dropdown-item" href="{{  url('admin/login') }}">Sign in as admin</a>
                        @else
