...
@section('content')
  <div class="row">
            ...
            <div class="card">
                ...
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <th>Registered At</th>
                            <td>{{  $order->user->created_at ? $order->user->created_at->diffForHumans(): '-'}}</td>
                        </tr>
        ...
        <div class="col-md-12">
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach ($order->products as $product)
                                    <table class="table">
                                        <tr>
                                            <td><img src="{{ url('upload') . '/' . $product->image }}" alt="" style="width: 5em"></td>
                                        </tr>
                                    </table>
                                @endforeach
                            </td>
            ...
            <a href="{{ url('/admin/order') }}" class="btn btn-info btn-fill btn-wd">back</a>
        </div>
    </div>
@endsection
